...
var Turtle = function(angle, distance, width, position, direction, up) {
    this.angle = angle;
...
Turtle.prototype.rule = function(axiom, rules) {
    this.axiom = axiom;
    this.rules = this.rules.concat(rules);
    return this;
};

Turtle.prototype.createEdges = function(iterations) {
    var edges = [];
...
Turtle.prototype.go = function(iterations, callbackForEdge) {
    ...
    var rotateright = new THREE.Vector3(), right = new THREE.Vector3(), next = new THREE.Vector3();
    ...
    var that = this;
    var verbose = false;
    var locationStack = [], programStack = [];
